...
from nips_hcnet.models.cgenn import CGENNNBodyNet
from nips_hcnet.models.nequip_nbody import NequIPNBodyNet
from nips_hcnet.data.nbody_dataset import get_nbody_loaders_3d_with_ood


def create_fallback_result(model_name, train_size, dim=3, error_msg=""):
    """Placeholder fallback when published baselines module is not available."""
    return None
